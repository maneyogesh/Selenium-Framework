...
public class TC028_ProbationRequestVerifyStatus extends TestBase {

	public static final Logger log = Logger.getLogger(TC028_ProbationRequestVerifyStatus.class.getName());
	...
	@DataProvider(name="ProbationVerify")
	...
	public void ProbationRequest(String SearchDropdownData, String SearchValue,String NOTUSE0, String NOTUSE1, String NOTUSE2, String NOTUSE3, String NOTUSE4, String NOTUSE5, String NOTUSE6, String NOTUSE7, String NOTUSE8, String NOTUSE9, String NOTUSE10, String NOTUSE11, String NOTUSE12, String NOTUSE13, String NOTUSE14, String NOTUSE15, String NOTUSE16, String NOTUSE17, String NOTUSE18, String NOTUSE19, String NOTUSE20, String NOTUSE21, String NOTUSE22, String NOTUSE23, String NOTUSE24, String NOTUSE28, String NOTUSE25, String NOTUSE27, String NOTUSE26, String NOTUSE30, String ApproveRejectStatus) throws Exception {
		...
		p.Test_Search_Record(SearchDropdownData, SearchValue);
		  ...
		  try {
			p.Test_VerifyProbationRequestEmployeeStatus(SearchValue, ApproveRejectStatus);
		 	ExcelUtils.setCellData("Passed", iTestCaseRow, Constant.Col_Result);
			ExcelUtils.setCellData("Probation Status showing properly", iTestCaseRow, Constant.Col_ActualResult);
			} catch (Exception e) {
			getScreenShot("Probation request status Verfiy");
			ExcelUtils.setCellData("Failed", iTestCaseRow, Constant.Col_Result);
			ExcelUtils.setCellData("Probation Status is not showing Properly", iTestCaseRow, Constant.Col_ActualResult);
			bc.log("Probation Status is not showing Properly");
			Assert.fail("Expected Status : ['Approved By HR' or 'Rejected By HR'] But Found : [Wrong Status]");
		}
	}
